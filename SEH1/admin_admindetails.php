...
$admin = query("SELECT * FROM admin_seh WHERE status = 0");
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <tbody >
                                            ...
                                            <tr class="clickable"
                                                ...
                                                <td><?= $row["email"]; ?></td>
                                                <td>
                                                    <a href="admin_hapusadminlist.php?id=<?= $row['id_admin']; ?>"><button type='button' style='font-size: 12px;' class='btn btn-outline-primary btn-sm'>Delete</button></a>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                            <?php endforeach ?>
                                ...
                                <nav class="list">
                                    <a href="admin_admindetails.php" style="text-align:center;"> See All List</a>
                                 </nav>
