...
<head>
  <meta charset="UTF-8">
  <title>Admin-Semar Event Hub</title>
  ...
  <div class="page-wrapper w-100 p-3">
    ...
    <div class="container-fluid">
      ...
      <section class="d-flex align-items-center">
        <div class="container justify-content-center align-items-center text-center mx-auto" style="width: 50%;">
          <img src="img/3515462.jpg" class="img-fluid">
          <h2>Welcome to <span>SEMAR Event Hub Admin</span></h2>
          <p>Click Menu On The Left To Start!</p>
        </div>
      </section>
    </div>
  </div>
