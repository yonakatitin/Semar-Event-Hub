...
<head>
  <meta charset="UTF-8">
  <title>View Event Request</title>
    ...
    <form class="row" action="" method="post" enctype="multipart/form-data" id="form">
      ...
      <div class="col">
        <div class="col mb-3">
          ...
          <input type="text" class="form-control" name="nama_event" id="event-name" disabled value="<?= $rqs["nama_event"]; ?>">
        </div>
        <div class="col mb-3">
          <label for="venue" class="form-label">Venue/Location</label>
          <input type="text" class="form-control" name="lokasi_event" id="venue" disabled value="<?= $rqs["lokasi_event"]; ?>">
        </div>
        <div class="row">
          <div class="col">
            <div class="mb-3">
              <label for="date" class="form-label">Start Date</label>
              <input type="date" class="form-control" name="tgl_event" id="date" disabled value="<?= $rqs["tgl_event"]; ?>">
            </div>
          </div>
          <div class="col">
            <div class="mb-3">
              <label for="date" class="form-label">End Date</label>
              <input type="date" class="form-control" name="tglakhir_event" id="date" disabled value="<?= $rqs["tglakhir_event"]; ?>">
            </div>
          </div>
        </div>
        <div class="col mb-3">
          <label for="desc" class="form-label">Description</label>
          <textarea class="form-control" name="deskripsi_event" id="desc" rows="3" disabled><?= $rqs["deskripsi_event"]; ?></textarea>
        </div>
        <div class="col mb-3">
          ...
          <select class="form-select" name="kategori_event" id="autoSizingSelect">
            <option value="1" <?php if($rqs['kategori_event'] == 1) {echo "selected";} ?> disabled>Concert</option>
            <option value="2" <?php if($rqs['kategori_event'] == 2) {echo "selected";} ?> disabled>Seminar</option>
            <option value="3" <?php if($rqs['kategori_event'] == 3) {echo "selected";} ?> disabled>Baazar</option>
            <option value="4" <?php if($rqs['kategori_event'] == 4) {echo "selected";} ?> disabled>Other</option>
          </select>
        </div>
        <div class="col mb-3">
          ...
          <input type="text" class="form-control" name="cp" id="cp" disabled value="<?= $rqs["cp"]; ?>">
        </div>
        <div class="col mb-3">
          ...
          <input type="text" class="form-control" name="regist_link" id="regist" disabled value="<?= $rqs["regist_link"]; ?>">
        </div>
      </div>
      <div class="col" align="center">
        ...
        <div class="col mb-3" id="file">
          ...
          <input type="file" title="<?= $rqs["image"]; ?>" class="form-control" name="image" id="image" onchange="preview()" style="visibility:hidden;" disabled>
        </div>
      </div>
    </form>
  </div>
                  ...
                  <div class="row flex-row-reverse">
                    <div class="col-auto float-end">
                      <button class="btn btn-success float-end">
                        <a href="acceptEvent.php?id=<?= $rqs["id"]; ?>" style="color:#ffffff;">Accept & Publish</a></button>
                    </div>
                    <div class="col-auto float-end">
                      <button class="btn btn-danger float-end">
                        <a href="rejectEvent.php?id=<?= $rqs["id"]; ?>" style="color:#ffffff;">Reject & Delete</a></button>
                    </div>
                  </div>
                </div>
            </div>
