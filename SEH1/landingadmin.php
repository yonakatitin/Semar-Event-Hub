                        ...
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                ...
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                    <a class="btn btn-success btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="user_login.php">User Login</a>
                                    <a class="btn btn-dark btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder text-white" href="admin_login.php">Admin Login</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-7">
