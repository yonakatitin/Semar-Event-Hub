    ...
    <div class="page-wrapper w-100 p-3">
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles w-100 p-3">
                ...
                <div class="col align-items-center float-end">
                    <button class="btn btn-success float-end">
                        <a href="addeventsadmin.php" style="color:#ffffff;">Add Event</a></button>
                </div>
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr class="clickable"
                                        ...
                                        <td><a href="admin_detail_event.php?id=<?= $row['id']; ?>" style="text-decoration: none; color: black;"><?= $row["nama_event"]; ?></a></td>
                                        <td><?= $row["tgl_event"]; ?></td>
